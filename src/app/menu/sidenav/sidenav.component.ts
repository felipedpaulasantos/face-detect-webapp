...
export class SidenavComponent implements OnInit {
  ...
  menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      children: [
        {
          displayName: 'Novo Grupo',
          children: [
            {
              displayName: 'Opção aninhada',
              children: [
                {
                  displayName: 'Opção aninhada 2',
                  route: '/home'
                }
              ]
            }
        ...
        {
          displayName: 'Consultar grupos',
          route: '/person-group/list'
        },
        {
          displayName: 'Deletar grupos'
        }
      ]
    },
    {
      ...
      children: [
        {
          ...
          route: '/servicos/detectar'
        },
        {
          displayName: 'Comparar',
          route: '/servicos/comparar'
        }
      ]
    }
  ];
